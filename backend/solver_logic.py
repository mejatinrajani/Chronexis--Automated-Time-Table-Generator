#this is the version-9 of our solver at it perfectly generates the compact time-table includinig the load balancing
#no free periods>2 and all the other soft constraints.
